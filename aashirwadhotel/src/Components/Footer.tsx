      ...
      <div className="w-full bg-[#10377a]   p-10 text-white">
        <div className="flex flex-wrap  justify-between gap-10 mx-auto pb-5 lg:w-10/12">
          <div className="flex flex-col gap-7">
            <h1 className="text-[25px] 2xl:text-[45px] font-heading">INFO</h1>
            <div className="flex flex-col font-text text-[18px] 2xl:text-[28px] gap-4">
              <p className="flex ">
          ...
          <div className="flex flex-col gap-7">
            <h1 className="text-[25px] 2xl:text-[45px] font-heading">
              About Us
            </h1>
            <ul className="list-none flex font-text flex-col text-[18px] 2xl:text-[28px] gap-3">
              ...
              <li className="cursor-pointer">
                <Link to="/contactus">Our Location</Link>
              </li>
            </ul>
          </div>
          <div className="flex flex-col gap-7">
            <h1 className="text-[25px] 2xl:text-[45px] text-center font-heading">
              Quick Links
            </h1>
            <div className="flex flex-wrap font-text lg:gap-32 gap-10 ">
              <ul className="list-none flex flex-col text-[18px] 2xl:text-[28px] gap-3">
        ...
        <div className="flex justify-center items-center py-10 gap-10 flex-col">
          ...
          <h1 className="font-heading text-[30px] 2xl:text-[40px] text-center ">
            HOTEL&nbsp;AASHIRWAD
          </h1>
        </div>
        <div className="w-full text-center 2xl:text-lg  text-xs">
